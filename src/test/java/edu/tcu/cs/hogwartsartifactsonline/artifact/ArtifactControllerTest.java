...
class ArtifactControllerTest {
    ...
    void testSaveSuccess() throws Exception {
        // Given
        ArtifactDto newArtifactDto = new ArtifactDto(null,
                "Remembrall",
    ...
    void testUpdateArtifactErrorWithNonExistentId() throws Exception {
        ...
        given(this.artifactService.update(eq("1250808601744904192"),Mockito.any(Artifact.class))).willThrow(new ObjectNotFoundException("artifact", "1250808601744904197"));
    ...
    void testDeleteArtifactSuccess() throws Exception {
        ...
        // When and Then
        this.mockMvc.perform(delete(this.baseUrl + "/artifacts/1250808601744904193").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testDeleteArtifactErrorWithNonExistentId() throws Exception {
        // Given
        doThrow(new ObjectNotFoundException("artifact", "1250808601744904193")).when(this.artifactService).delete("1250808601744904193");
