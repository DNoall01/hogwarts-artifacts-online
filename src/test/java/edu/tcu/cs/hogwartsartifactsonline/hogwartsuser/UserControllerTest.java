...
public class UserControllerTest {
    ...
    void testAddUserSuccess() throws Exception {
        ...
        given(this.userService.save(Mockito.any(HogwartsUser.class))).willReturn(u);
    ...
    void testUpdateUserErrorWithNonExistentId() throws Exception {
        // Given
        given(this.userService.update(eq(3), Mockito.any(HogwartsUser.class))).willThrow(new ObjectNotFoundException("user", 3));
